// WinApiLeaning.cpp : Defines the entry point for the application.
//
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_WINAPILEANING));
    ...
    case WM_PAINT:
        {
            ...
            TextOut(hdc, 0, 0, szBuffer,wsprintf(szBuffer,TEXT("%d"),num));
            EndPaint(hWnd, &ps);
        }
        break;
    case WM_DESTROY:
